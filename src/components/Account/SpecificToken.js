    ...
    <div>
      ...
      >
        ...
        <div className={`grid rounded-lg col-span-4 gap-10`}>
          <div>
            <div className={`px-5 py-3 rounded-lg bg-[#ADFEDC] text-center `}>
          ...
          <div>
            <div className={` bg-[${background}] rounded-t-[30px] `}>
              <div
                className={`bg-[${button}] rounded-t-[30px]  border-[${border}] border-[1px] border-b-0 flex items-center`}
                style={{ boxShadow: "1px 2px 6px rgba(151, 164, 175, 0.05)" }}
              >
                <button
                  className={`w-1/2 p-4 rounded-tl-[30px] text-[${font}] hover:text-[${fontHolder}] hover:bg-gradient-to-bl hover:from-slate-500/10 hover:to-slate-500/0`}
                  onClick={() => {}}
                >
                  Presale
                </button>
                <hr className={`h-10 w-[1px] bg-[${backgroundHolder}]`} />
                <button
                  className={`w-1/2 p-4 rounded-tr-[30px]  text-[${font}] hover:text-[${fontHolder}] hover:bg-gradient-to-bl hover:from-slate-500/10 hover:to-slate-500/0 `}
                  onClick={() => {}}
                >
                  Info
                </button>
              ...
              <div
                className={`bg-[${background} items-center flex px-5 py-8 h-full col-span-4 row-span-2  border-[${border}] border-[1px] border-t-0`}
                style={{ boxShadow: "0 6px 9px rgba(151, 164, 175, 0.05)" }}
              >
                <button
                  className={`rounded-full bg-[${button}] w-full py-3 my-auto border-[${border}] border-[1px] hover:text-[${fontHolder}] hover:bg-slate-500/10`}
                >
                  Connect Wallet
                </button>
              </div>

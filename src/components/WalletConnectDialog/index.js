...
const WalletConnectDialog = ({ modalState, closeModal, buttonRef }) => {
  ...
  return (
    <Dialog modalState={modalState} closeModal={closeModal} button={buttonRef}>
            ...
            <li>
              ...
              >
                ...
                >
                  <linearGradient
                    id="a"
                    gradientTranshtmlForm="matrix(0 -54.944 -54.944 0 23.62 79.474)"
                  ...
                  <linearGradient
                    id="b"
                    gradientTranshtmlForm="matrix(0 -48.595 -48.595 0 37.854 76.235)"
                    gradientUnits="userSpaceOnUse"
                    x2="1"
                  >
                  ...
                  <g transhtmlForm="matrix(1.3333 0 0 -1.3333 0 107.2)">
                    <path
      ...
      <DialogFooter>
        <div
          className={`flex justify-between px-3 text-[${fontHolder}] font-bold `}
        >
          <p>v1</p>
          <p>block 17477869</p>
        </div>

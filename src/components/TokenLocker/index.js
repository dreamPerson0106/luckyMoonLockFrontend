    ...
    <div className=" container mx-auto pt-10 pb-7 text-white max-w-xl">
      <div className="relative z-10">
        <button
          ...
          className={`w-full justify-between text-[${fontHolder}] text-lg bg-[${background}] hover:bg-[${hover}] focus:outline-none  font-medium rounded-lg text-sm px-4 py-2.5 text-center inline-flex items-center `}
          type="button"
          ref={btnref}
          onClick={() => {
        ...
        {selecterStatus ? (
          <div
            id="dropdownDivider"
            ref={ref}
            className={` w-full bg-[${background}] divide-y divide-gray-100 rounded-lg shadow max-w-xl z-10 absolute top-14 left-0`}
          >
            <ul

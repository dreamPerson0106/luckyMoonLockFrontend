      ...
      <div className=" mx-auto my-52 relative w-full max-w-lg max-h-full">
        <div className={`relative bg-[${background}] rounded-lg shadow`}>
          <button
            ...
            data-modal-hide="splitlock-modal"
          >
            <svg
              aria-hidden="true"
              className="w-5 h-5"
          ...
          <div className="px-6 py-6 lg:px-8">
            ...
            <form className="space-y-6" action="#">
              <div>
                ...
                >
                  Split this lock into another lock with speclifed amount.
                  Usefull if you have one large lock thats about to become
                  withdrawable and you’d like to split out say 10% and withdraw
                  for marketing or some other usecase and relock the remaining
                  90%.
                </label>
